        ...
        return (
            <div className="pagination-container">
                ...
                <div className={pager.currentPage === 1 ? 'disabled' : 'pagination-container__left-arrow'}>
                    <a className="pagination-container__link" onClick={() => this.setPage(pager.currentPage - 1)}><img src={leftSvg}/></a>
                </div>
                <ul className='pagination'>
                {pager.pages.map((page, index) =>
                    <li key={index} className={pager.currentPage === page ? 'pagination__item pagination__item_type_active' : 'pagination__item'}>
                        <a className="pagination-container__link" onClick={() => this.setPage(page)}>{page}</a>
                    </li>
                )}
                </ul>
                <div className={pager.currentPage === pager.totalPages ? 'disabled' : 'pagination-container__right-arrow'}>
                    <a className="pagination-container__link" onClick={() => this.setPage(pager.currentPage + 1)}><img src={rightSvg}/></a>
                </div>
...
ProductPagination.defaultProps = defaultProps;
